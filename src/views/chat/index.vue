    ...
    <footer :class="footerClass">
      <div class="flex items-center justify-between space-x-2">
        <HoverButton tooltip="点击关闭或开启联网功能，开启后会自动从互联网获得信息来回答您，关闭联网能极大加快响应速度">
          <span class="text-sm text-[#4f555e]" @click="handleClear">
            <!-- <SvgIcon icon="ri:delete-bin-line" /> -->
            <span style="color: #2979ff; width: 28px; display: inline-block;" v-if="getEnabledNetwork">联网开启</span>
            <span style="color: red; width: 28px; display: inline-block;" v-if="!getEnabledNetwork">联网关闭</span>
          </span>
        </HoverButton>
...
#scrollRef {
  ...
  &::-webkit-scrollbar-thumb {
    ...
    opacity: 0.2;
    background: fade(#d5e9df, 60%);
  }

  &::-webkit-scrollbar-track {
    -webkit-box-shadow: inset 0 0 5px rgba(0, 0, 0, 0.2);
    border-radius: 10px;
    background: fade(#d5e9df, 30%);
  }
}
</style>
